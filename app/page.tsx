  ...
  return (
    <main className="wrap">
      <section className="hero">
        ...
        <h1>Neo<small>Chan</small></h1>
        <p className="lead">
          Anonymous imageboard built on neobrutalist principles.
          No accounts. No algorithms. Just threads, replies, greentext,
          and the occasional LN2 dewar.
        </p>
        <div className="meta">
      ...
      <section className="rules">
        ...
        <ol>
          ...
          <li><code>sage</code> in the email field to not bump a thread.</li>
      ...
      <section className="rules">
        ...
        <p style={{ fontSize: 15, lineHeight: 1.7 }}>
          NeoChan is built on <b>Next.js</b> with posts persisted in <b>Redis (Upstash)</b>.
          Image uploads go straight to <b>Upstash Blob</b> so we never touch your files on our servers.
          Threads purge oldest-first when a board hits capacity. The rest is up to the anons.
        </p>
      </section>
    </main>
  );
